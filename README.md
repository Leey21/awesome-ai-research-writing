...
| Skill 名称 | 来源 | 功能简述 |
|------------|------|----------|
| **suppr-skills** | [WildDataX/suppr-skills](https://github.com/WildDataX/suppr-skills) | Claude Code skills for Suppr document translation and academic literature search APIs. Useful for literature search, academic document translation, and research-reading workflows. |
