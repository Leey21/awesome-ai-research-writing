...
可补充的研究工具：**[Paperzilla](https://github.com/paperzilla-ai/paperzilla-skills)**（[ClawHub](https://clawhub.ai/pors/paperzilla)）适合生物学与医学研究中的对话式文献监测与论文问答。当前支持基于项目的 bioRxiv 与 medRxiv feed，可抓取论文 Markdown 供摘要与相关性评估，后续计划支持 PubMed。
...
| **Paperzilla** | [paperzilla-ai/paperzilla-skills](https://github.com/paperzilla-ai/paperzilla-skills) | 面向生物学与医学研究的对话式文献监测与论文问答工具。当前支持基于项目的 bioRxiv 与 medRxiv feed，可抓取论文 Markdown 供摘要与相关性评估，后续计划支持 PubMed。 |
