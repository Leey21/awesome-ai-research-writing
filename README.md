...
### Part III: 推荐工具 (Recommended Tools)
- [引用与参考文献管理](#引用与参考文献管理)
...
> 💡 除了 Prompt 和 Skills，以下工具可以进一步提升论文写作效率

## 引用与参考文献管理

| 工具 | 简介 |
|------|------|
| **[CiteMe](https://citeme.app)** | AI 驱动的学术引用生成器。搜索 11+ 个学术数据库（OpenAlex、PubMed、Semantic Scholar、CrossRef 等），支持 40+ 种引用格式（APA、ABNT、MLA、Chicago、Vancouver 等）。提供网页版、Chrome 扩展、Google Docs 插件和 Word 加载项。 |
