...
可补充的研究工具：**[Paperzilla](https://github.com/paperzilla-ai/paperzilla-skills)**（[ClawHub](https://clawhub.ai/pors/paperzilla)）适合科研场景中的对话式文献监测与论文问答。当前支持基于项目的 arXiv、bioRxiv、medRxiv、ChemRxiv feed，以及 scholar alerts；可抓取论文 Markdown 供摘要与相关性评估，后续计划支持 PubMed。
...
| **Paperzilla** | [paperzilla-ai/paperzilla-skills](https://github.com/paperzilla-ai/paperzilla-skills) | 面向科研场景的对话式文献监测与论文问答工具。当前支持基于项目的 arXiv、bioRxiv、medRxiv、ChemRxiv feed，以及 scholar alerts；可抓取论文 Markdown 供摘要与相关性评估，后续计划支持 PubMed。 |
