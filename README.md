...
| **agent-shadow-brain** | [theihtisham/agent-shadow-brain](https://github.com/theihtisham/agent-shadow-brain) | AI-powered background code analysis agent with neural mesh, pattern memory, and real-time insights — helps developers write better code through continuous analysis during research and writing workflows. |
